...
export const products: Product[] = [
  ...
  },
  {
    ...
    batch: "JAN-151645-REF",
    lab: "Janoshik",
    coaId: "JAN-151645-GHKCU50-REF",
    testDate: "2026-05-20",
    ...
    reportStatus: "available",
    sourceNote:
      "Using the supplied GHK-cu 100mg Janoshik result as the supporting lab result for this GHK-cu 50mg listing.",
    concentration: "50mg",
    storage: "Store sealed and temperature controlled. Keep protected from light.",
    referenceStandard: "Supplied GHK-cu 100mg Janoshik report is used as the supporting result for this 50mg listing.",
